...
const Signin = () => {
	...
	const { inputs, setInputs, handleSignin, errors } = useContext(firebaseAuth);
	console.log(errors);
	...
	return (
		<Container>
			<Grid container justify="center">
				...
				>
					<Grid item sm={12}>
						<h3 className={classes.headingStyle}>Login to Your Account</h3>
					</Grid>
					...
					<Link to="/signup">
						<Typography variant="h6">New User? Signup</Typography>
					</Link>
				</Grid>
			</Grid>
		</Container>
